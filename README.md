...
| 0004 | [Print X N numbers of times](./DSA/General/print-x-n-numbers-of-times) | [JAVA](./DSA/General/print-x-n-numbers-of-times/solution.java) | 🟢 Easy | `DSA` |
| 0005 | [Sum of first last element in array](./DSA/Arrays/sum-of-first-last-element-in-array) | [JAVA](./DSA/Arrays/sum-of-first-last-element-in-array/solution.java) | 🟢 Easy | `DSA` / `Arrays` |
| 0006 | [Switch Case](./DSA/General/switch-case) | [JAVA](./DSA/General/switch-case/solution.java) | 🟢 Easy | `DSA` |
