...
| 0004 | [Practice (Classes and Objects)](./DSA/Introduction-to-OOPS/practice-classes-and-objects) | [JAVA](./DSA/Introduction-to-OOPS/practice-classes-and-objects/solution.java) | 🟡 Medium | `DSA` / `Introduction-to-OOPS` |
| 0005 | [Print last character of string](./DSA/Strings/print-last-character-of-string) | [JAVA](./DSA/Strings/print-last-character-of-string/solution.java) | 🟢 Easy | `DSA` / `Strings` |
| 0006 | [Print X N numbers of times](./DSA/General/print-x-n-numbers-of-times) | [JAVA](./DSA/General/print-x-n-numbers-of-times/solution.java) | 🟢 Easy | `DSA` |
| 0007 | [Sum of first last element in array](./DSA/Arrays/sum-of-first-last-element-in-array) | [JAVA](./DSA/Arrays/sum-of-first-last-element-in-array/solution.java) | 🟢 Easy | `DSA` / `Arrays` |
| 0008 | [Switch Case](./DSA/General/switch-case) | [JAVA](./DSA/General/switch-case/solution.java) | 🟢 Easy | `DSA` |
